...
import com.spring.http.WafRequestWrapper;
...
public class HttpUtilExt {
    ...
    public static String getRemoteHost(){
        return HttpUtilExt.getRequest().getRemoteHost();
    }

    public static String getIpAddress() {
        HttpServletRequest request = HttpUtilExt.getRequest();
    ...
    public static Object getHttpSessionAttribute(String attributeName) {
        ...
        HttpSession session = HttpUtilExt.getRequest().getSession();
